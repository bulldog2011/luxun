...
public class FindClosestIndexByTimeResponse implements org.apache.thrift.TBase<FindClosestIndexByTimeResponse, FindClosestIndexByTimeResponse._Fields>, java.io.Serializable, Cloneable, Comparable<FindClosestIndexByTimeResponse> {
  ...
  static {
    schemes.put(StandardScheme.class, new FindClosestIndexByTimeResponseStandardSchemeFactory());
    schemes.put(TupleScheme.class, new FindClosestIndexByTimeResponseTupleSchemeFactory());
  }

  private Result result; // required
  private long index; // required
  private long timestampOfIndex; // required
  ...
  public void unsetTimestampOfIndex() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __TIMESTAMPOFINDEX_ISSET_ID);
  }
  ...
  public boolean isSetTimestampOfIndex() {
    return EncodingUtils.testBit(__isset_bitfield, __TIMESTAMPOFINDEX_ISSET_ID);
  }

  public void setTimestampOfIndexIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __TIMESTAMPOFINDEX_ISSET_ID, value);
  }
  ...
  public int hashCode() {
    ...
    boolean present_timestampOfIndex = true;
    list.add(present_timestampOfIndex);
    if (present_timestampOfIndex)
      list.add(timestampOfIndex);
  ...
  public int compareTo(FindClosestIndexByTimeResponse other) {
    ...
    lastComparison = Boolean.valueOf(isSetTimestampOfIndex()).compareTo(other.isSetTimestampOfIndex());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTimestampOfIndex()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.timestampOfIndex, other.timestampOfIndex);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class FindClosestIndexByTimeResponseStandardSchemeFactory implements SchemeFactory {
    public FindClosestIndexByTimeResponseStandardScheme getScheme() {
      return new FindClosestIndexByTimeResponseStandardScheme();
    }
  }

  private static class FindClosestIndexByTimeResponseStandardScheme extends StandardScheme<FindClosestIndexByTimeResponse> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, FindClosestIndexByTimeResponse struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, FindClosestIndexByTimeResponse struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      oprot.writeI64(struct.timestampOfIndex);
      oprot.writeFieldEnd();
  ...
  private static class FindClosestIndexByTimeResponseTupleSchemeFactory implements SchemeFactory {
    public FindClosestIndexByTimeResponseTupleScheme getScheme() {
      return new FindClosestIndexByTimeResponseTupleScheme();
    }
  }

  private static class FindClosestIndexByTimeResponseTupleScheme extends TupleScheme<FindClosestIndexByTimeResponse> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, FindClosestIndexByTimeResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetTimestampOfIndex()) {
        optionals.set(1);
      }
