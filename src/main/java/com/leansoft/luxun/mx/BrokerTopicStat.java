...
public class BrokerTopicStat implements BrokerTopicStatMBean, IMBeanName {
    ...
    static class BrokerTopicStatHolder {
        ...
        static {
            allTopicState.mBeanName = "luxun:type=luxun.BrokerAllTopicStat";
    ...
    public static BrokerTopicStat getInstance(String topic) {
        ...
        if (state == null) {
            ...
            state.mBeanName = "luxun:type=luxun.BrokerTopicStat." + topic;
    ...
    private final AtomicLong numCumulatedFailedConsumeRequests = new AtomicLong(0);
    ...
    public long getFailedConsumeRequest() {
        return numCumulatedFailedConsumeRequests.get();
    }
    ...
    public void recordFailedConsumeRequest() {
        numCumulatedFailedConsumeRequests.getAndIncrement();
    }
